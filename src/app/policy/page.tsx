  ...
  return (
    <div className="page-wrapper relative z-[1] bg-white">
      ...
      <main className="main-wrapper relative overflow-hidden">
        <section className="section-features pt-28 md:pt-36" id="about">
          {/* Section Space */}
          <div className="section-space-bottom">
            ...
            <div className="container-default">
              ...
              <p>
                This privacy policy applies to the Orderfiti app (hereby
                referred to as &quot;Application&quot;) for mobile devices that
                was created by Twisac (hereby referred to as &quot;Service
              ...
              <div style={{ display: "none" }}>
                <p>
                  The Application collects your device&apos;s location, which
                ...
                <ul>
                  ...
                  <li>
                    ...
                    transmit anonymized location data to external services.
              ...
              <p>
                ...
                to info@orderfiti.com. The information that the Service Provider
              ...
              <p>
                ...
                info@orderfiti.com and they will respond in a reasonable time.
              </p>
              <br />
              ...
              <div>
                ...
                <p>
                  ...
                  Service Provider (info@orderfiti.com) so that they will be
              ...
              <p>
                ...
                contact the Service Provider via email at info@orderfiti.com.
              </p>
              <hr />
            </div>
          </div>
